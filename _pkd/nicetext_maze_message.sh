...
INPUT_FILE="$ROOT_DIR/_pkd/_message.txt"
OUTPUT_FILE="$ROOT_DIR/_pkd/_message.a_maze_of_death.nicetext.txt"
RESTORED_FILE="$ROOT_DIR/_pkd/_message.a_maze_of_death.restored.txt"
PREFIX="$ROOT_DIR/_pkd/build/a_maze_of_death"
